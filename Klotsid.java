...
public class Klotsid {
    ...
    public void kontrolliLiikumisPõrget(ArrayList<Plokk> staatilisedPlokid, int vasak_x, int parem_x, int alumine_y) {
        ...
        // Seina ja põranda kokkupõrke kontroll
        for (Plokk plokk : a) {
            if (plokk.x <= vasak_x) {
                vasakPõrge = true;
            }
        ...
        // Staatilise klotsi kokkupõrke kontroll
    ...
    public void uuenda() {
        ...
        if (põhjaPõrge) {
            // põhjapõrke korral klots deaktiveeritakse ning automaatne allapoole liikumine peatub
            mitteaktiivne = true;
        } else {
